    ...
    <View className="mx-6 my-3 p-5 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800">
      <View className="flex-row items-center justify-between mb-5">
        ...
        <View className="bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-lg border border-slate-200 dark:border-slate-700">
          <Text className="text-xs font-mono font-bold text-slate-600 dark:text-slate-400">
            v{version}
          </Text>
        </View>
      </View>
      ...
      <Text className="text-center mt-3 text-slate-400 dark:text-slate-500 text-[10px] uppercase tracking-tighter">
        Verificación de integridad y parches de seguridad
      </Text>
    </View>
  );
};
