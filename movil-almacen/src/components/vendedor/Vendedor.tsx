  ...
  return (
    <View className="mx-6 my-3 p-6 bg-white dark:bg-slate-900 rounded-3xl shadow-md border border-slate-100 dark:border-slate-800">
      <View className="flex-row items-center mb-6">
        ...
        <View>
          ...
          <Text className="text-slate-500 dark:text-slate-400 text-sm">
            Configuración de la contraseña y codigo del vendedor
          </Text>
        </View>
      </View>
      ...
      <View>
        <Pressable
          onPress={handleUser}
          className="bg-slate-900 dark:bg-white active:bg-slate-800 dark:active:bg-slate-200 rounded-xl px-4 py-3 items-center justify-center"
        >
